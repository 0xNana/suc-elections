...
\restrict zzc57t0wO6xzUhAxnnH7SWeDRFPS7uh5zLnZ8f0R1cWWkwr8MpNoGqlbepxVAIg
...
--
-- Name: election_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.election_config (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    poll_opens timestamp with time zone NOT NULL,
    poll_closes timestamp with time zone NOT NULL,
    is_locked boolean DEFAULT false,
    results_released_at timestamp with time zone,
    results_released_by uuid,
    results_counted_at timestamp with time zone,
    results_counted_by uuid
);


--
-- Name: COLUMN election_config.results_released_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.election_config.results_released_at IS 'Set by an EC account when results are intentionally released to the public.';


--
-- Name: COLUMN election_config.results_released_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.election_config.results_released_by IS 'Auth user id of the EC account that released results to the public.';


--
-- Name: COLUMN election_config.results_counted_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.election_config.results_counted_at IS 'Set by an EC account when the official count is generated for review.';


--
-- Name: COLUMN election_config.results_counted_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.election_config.results_counted_by IS 'Auth user id of the EC account that generated the official count.';
...
--
-- Name: result_verifications; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.result_verifications (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    election_config_id uuid NOT NULL,
    verifier_auth_user_id uuid NOT NULL,
...
--
-- Name: TABLE result_verifications; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.result_verifications IS 'Verification messages from aspirant reps after the EC has generated the official count.';
...
COMMENT ON TABLE public.votes IS 'Append-only vote ledger. Supabase Realtime must never subscribe directly to this table.';
...
CREATE VIEW public.results WITH (security_invoker='on') AS
 SELECT p.id AS position_id,
   ...
   FROM ((public.positions p
     ...
     LEFT JOIN public.votes v ON (((v.candidate_id = c.id) AND (v.position_id = p.id))))
  GROUP BY p.id, p.title, p.display_order, c.id, c.full_name, c.ballot_num, c.photo_url
  ORDER BY p.display_order, ((count(v.id))::integer) DESC, c.ballot_num;


--
-- Name: VIEW results; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.results IS 'Canonical aggregated count surface for SUC-VOTE. Query through the backend so the public seal remains enforceable until polls close.';
...
CREATE TABLE public.students (
    ...
    role character varying(20) DEFAULT 'voter'::character varying NOT NULL,
    can_vote boolean DEFAULT true NOT NULL,
    CONSTRAINT valid_role CHECK (((role)::text = ANY ((ARRAY['voter'::character varying, 'aspirant_rep'::character varying, 'ec_admin'::character varying])::text[])))
);


--
-- Name: COLUMN students.can_vote; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.students.can_vote IS 'Controls whether this person may access the ballot and cast votes, independently of dashboard/admin role.';
...
--
-- Name: election_config election_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.election_config
    ADD CONSTRAINT election_config_pkey PRIMARY KEY (id);
...
--
-- Name: result_verifications result_verifications_election_config_id_verifier_auth_user__key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_verifications
    ADD CONSTRAINT result_verifications_election_config_id_verifier_auth_user__key UNIQUE (election_config_id, verifier_auth_user_id);


--
-- Name: result_verifications result_verifications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_verifications
    ADD CONSTRAINT result_verifications_pkey PRIMARY KEY (id);
...
--
-- Name: students students_voter_token_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_voter_token_key UNIQUE (voter_token);
...
--
-- Name: votes votes_voter_token_position_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.votes
    ADD CONSTRAINT votes_voter_token_position_id_key UNIQUE (voter_token, position_id);
...
--
-- Name: audit_log_logged_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX audit_log_logged_at_idx ON public.audit_log USING btree (logged_at DESC);


--
-- Name: candidates_position_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_activation_code; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_activation_code ON public.students USING btree (activation_code) WHERE ((activated_at IS NULL) AND (activation_code IS NOT NULL));


--
-- Name: idx_student_id_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_student_id_lookup ON public.students USING btree (student_id);


--
-- Name: idx_students_activation_code_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_students_activation_code_unique ON public.students USING btree (activation_code) WHERE (activation_code IS NOT NULL);


--
-- Name: positions_display_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX positions_display_order_idx ON public.positions USING btree (display_order);


--
-- Name: result_verifications_config_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX result_verifications_config_idx ON public.result_verifications USING btree (election_config_id, verified_at DESC);


--
-- Name: votes_position_candidate_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX votes_position_candidate_idx ON public.votes USING btree (position_id, candidate_id);
...
--
-- Name: audit_log no_delete_audit; Type: RULE; Schema: public; Owner: -
--
...
--
-- Name: votes no_delete_votes; Type: RULE; Schema: public; Owner: -
--

CREATE RULE no_delete_votes AS
    ON DELETE TO public.votes DO INSTEAD NOTHING;


--
-- Name: audit_log no_update_audit; Type: RULE; Schema: public; Owner: -
--
...
--
-- Name: votes no_update_votes; Type: RULE; Schema: public; Owner: -
--

CREATE RULE no_update_votes AS
    ON UPDATE TO public.votes DO INSTEAD NOTHING;
...
--
-- Name: election_config election_config_results_counted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.election_config
    ADD CONSTRAINT election_config_results_counted_by_fkey FOREIGN KEY (results_counted_by) REFERENCES auth.users(id);


--
-- Name: election_config election_config_results_released_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.election_config
    ADD CONSTRAINT election_config_results_released_by_fkey FOREIGN KEY (results_released_by) REFERENCES auth.users(id);


--
-- Name: result_verifications result_verifications_election_config_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_verifications
    ADD CONSTRAINT result_verifications_election_config_id_fkey FOREIGN KEY (election_config_id) REFERENCES public.election_config(id) ON DELETE CASCADE;


--
-- Name: result_verifications result_verifications_verifier_auth_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_verifications
    ADD CONSTRAINT result_verifications_verifier_auth_user_id_fkey FOREIGN KEY (verifier_auth_user_id) REFERENCES auth.users(id);
...
CREATE POLICY audit_insert ON public.audit_log FOR INSERT TO service_role WITH CHECK (true);
...
--
-- Name: audit_log audit_read_for_reps; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY audit_read_for_reps ON public.audit_log FOR SELECT TO authenticated USING ((COALESCE((auth.jwt() ->> 'role'::text), ((auth.jwt() -> 'app_metadata'::text) ->> 'role'::text)) = 'aspirant_rep'::text));
...
--
-- Name: candidates candidates_public_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY candidates_public_read ON public.candidates FOR SELECT TO authenticated, anon USING (true);


--
-- Name: students ec_admin_manage_students; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ec_admin_manage_students ON public.students TO authenticated USING ((COALESCE((auth.jwt() ->> 'role'::text), ((auth.jwt() -> 'app_metadata'::text) ->> 'role'::text)) = 'ec_admin'::text)) WITH CHECK ((COALESCE((auth.jwt() ->> 'role'::text), ((auth.jwt() -> 'app_metadata'::text) ->> 'role'::text)) = 'ec_admin'::text));


--
-- Name: election_config; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.election_config ENABLE ROW LEVEL SECURITY;

--
-- Name: election_config election_config_public_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY election_config_public_read ON public.election_config FOR SELECT TO authenticated, anon USING (true);
...
--
-- Name: positions positions_public_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY positions_public_read ON public.positions FOR SELECT TO authenticated, anon USING (true);


--
-- Name: result_verifications; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: votes votes_insert_via_service; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY votes_insert_via_service ON public.votes FOR INSERT TO service_role WITH CHECK (true);


--
-- Name: votes votes_no_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY votes_no_select ON public.votes FOR SELECT USING (false);
...
\unrestrict zzc57t0wO6xzUhAxnnH7SWeDRFPS7uh5zLnZ8f0R1cWWkwr8MpNoGqlbepxVAIg
